...
To build the final jar and optimize the blitzAccount application for production, run:
...
Then navigate to [http://localhost:8586](http://localhost:8586) in your browser.

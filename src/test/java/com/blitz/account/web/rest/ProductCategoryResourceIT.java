...
import static com.blitz.account.domain.ProductCategoryAsserts.*;
...
import com.blitz.account.domain.ProductCategory;
import com.blitz.account.repository.ProductCategoryRepository;
...
class ProductCategoryResourceIT {
    ...
    public static ProductCategory createEntity() {
        return new ProductCategory().name(DEFAULT_NAME);
    }
    ...
    public static ProductCategory createUpdatedEntity() {
        return new ProductCategory().name(UPDATED_NAME);
    }

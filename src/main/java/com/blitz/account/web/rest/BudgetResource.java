...
import com.blitz.account.service.BudgetService;
...
/**
 * REST controller for managing {@link com.blitz.account.domain.Budget}.
 */
@RestController
...
public class BudgetResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Budget>> getAllBudgets(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {

...
import com.blitz.account.service.CurrencyService;
...
/**
 * REST controller for managing {@link com.blitz.account.domain.Currency}.
 */
@RestController
...
public class CurrencyResource {
    ...
    public ResponseEntity<Currency> createCurrency(@Valid @RequestBody Currency currency) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/currencies/" + currency.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, currency.getId().toString()))
            .body(currency);
    }

...
import com.blitz.account.repository.TransactionRepository;
...
/**
 * Service Implementation for managing {@link com.blitz.account.domain.Transaction}.
 */
@Service
@Transactional
    ...
    public Optional<Transaction> partialUpdate(Transaction transaction) {
        ...
        return transactionRepository
            ...
            .map(existingTransaction -> {
                ...
                if (transaction.getVatRateId() != null) {
                    existingTransaction.setVatRateId(transaction.getVatRateId());
                }
                if (transaction.getCurrencyId() != null) {
                    existingTransaction.setCurrencyId(transaction.getCurrencyId());
                }

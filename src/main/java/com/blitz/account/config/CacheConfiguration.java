package com.blitz.account.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.blitz.account.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.blitz.account.repository.UserRepository.USERS_BY_EMAIL_CACHE);

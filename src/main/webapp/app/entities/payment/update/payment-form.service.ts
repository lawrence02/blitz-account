...
type PaymentFormGroupContent = {
  ...
  currencyId: FormControl<PaymentFormRawValue['currencyId']>;
  bankAccountId: FormControl<PaymentFormRawValue['bankAccountId']>;
  invoiceId: FormControl<PaymentFormRawValue['invoiceId']>;
};
...
export class PaymentFormService {
  createPaymentFormGroup(payment: PaymentFormGroupInput = { id: null }): PaymentFormGroup {
    ...
    return new FormGroup<PaymentFormGroupContent>({
      ...
      currencyId: new FormControl(paymentRawValue.currencyId),
      bankAccountId: new FormControl(paymentRawValue.bankAccountId),
      invoiceId: new FormControl(paymentRawValue.invoiceId),
    });
  }
